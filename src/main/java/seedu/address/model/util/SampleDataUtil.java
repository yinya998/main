...
public class SampleDataUtil {
    ...
    public static Event[] getSampleEvent() {
        return new Event[]{
            ...
            new Event(new seedu.address.model.event.Name("Software Engineer interview"), new Description("google"),
                    new Venue("Lia tower, #12-13"), new DateTime("2019-04-17 10:00:00"),
                    new DateTime("2019-04-17 11:00:00"), new Label("hard")),
