...
public class PersonInfoHandle extends NodeHandle<Node> {
    ...
    public static final String PERSON_INFO_ID = "#personInfoView";
    ...
    public PersonInfoHandle(Node personInfoNode) {
        ...
        WebView webView = getChildNode(PERSON_INFO_ID);
    ...
    public URL getLoadedUrl() {
        return WebViewUtil.getLoadedUrl(getChildNode(PERSON_INFO_ID));
    }
