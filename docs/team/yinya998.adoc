...
** What it does: These two commands support different search patterns. The `find` command searches for people in contact list easily. User can search a person through exact keyword match, fuzzy keyword match and wildcard keyword match.
