...
** What it does: allows the user to import contacts and events from a .json file, as well as exporting them to a .json file by tags
...
* *Major enhancement*: support storage for events
** What it does: autosaves any newly added events and displays the all the events from last sessions upon app launch.
** Justification: Users want the added events to remain in the app even after it is closed.
