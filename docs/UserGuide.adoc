...
Imports the data from an external .json file to the address book. The file may contains data about Contacts, Events and Reminders.  +
...
Exports the data to an external .json file from the address book. The file will contain all events, all reminders, and all contacts bearing the tag specified. +
