...
Clear photo to a person in the contact list by sub-command `clear`, photo of the person will be set to default photo.
...
`photo 3 clear` (in mac) +
    Clear photo to the 3rd person in the address book. Photo is set to default photo.
