...
`connect ci/3 ei/19`
Add the 3rd person from Contact List into the 19th event in the Event List.
...
`listE` +
Find the event index from Event List+
`disconnect ci/3 ei/19`
Disconnect the 3rd person from Contact List with 19th event in the Event List.
