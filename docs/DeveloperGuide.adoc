...
image::EventClassDiagram.png[width="800"]
...
// end::eventlistcomponent[]

// tag::contacteventconnection[]
...
image::EventContactReference.png[width="800"]
