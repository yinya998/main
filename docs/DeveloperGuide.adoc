...
. The parser removes duplicate indices by using a `java.util.HashSet` instance. The Index class has already overriden `hashCode()`.
...
image::MeetCommandSequenceDiagram[width="800"]
