...
.. Test case: `addR 5 t/2 u/min` +
   Expected: For 5th event, we added a reminder which will pop up 2 minutes before 5th event's starting time. In the right panel, the list will add this reminder in the end.
.. Test case: `addR 5 t/3 u/mIN` +
   Expected: For 5th event, we added a reminder which will pop up 3 minutes before 5th event's starting time. In the right panel, the list will add this reminder in the end.
.. Test case: `addR 5 t/4 u/houR` +
   Expected: For 5th event, we added a reminder which will pop up 3 hours before 5th event's starting time. In the right panel, the list will add this reminder in the end.
.. Test case: `addR 5 t/4 u/hour` +
