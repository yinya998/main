...
In this user's current events list, there are five events that involve either persons 1, 2 or 3. These events are "in the way". They are depicted as red boxes in the following diagrams.
